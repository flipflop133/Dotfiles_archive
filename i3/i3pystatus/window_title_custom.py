...
class WindowTitle(Module):
    ...
    * `{class_name}` - name of application class
    ...
    settings = (
        ...
        ("always_show",
         "do not hide the title when it can be already visible"),
        ("empty_title",
         "string that will be shown instead of the title when the title is hidden"
         ),
    ...
    print(WindowTitle.get_title(self, conn))
